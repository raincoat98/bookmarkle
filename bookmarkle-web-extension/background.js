...
const notificationUrlMap = new Map(); // 알림 ID와 URL 매핑
...
async function getNotificationSettings(uid, idToken) {
  try {
...
// 시스템 알림 보내기
async function sendSystemNotification(title, message, bookmarkUrl = null) {
  try {
...
async function sendBookmarkSavedNotification(
  bookmarkId,
  bookmarkTitle,
  bookmarkUrl
) {

    ...
    <div className="flex h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      {isDesktop ? (
        <motion.div
          initial={false}
          animate={{
            width: isDrawerCollapsed ? 64 : 288,
          }}
          transition={{
            type: "spring",
            stiffness: 300,
        ...
        <motion.div
          ...
          className="fixed inset-y-0 left-0 z-[9999] w-72"
        >
          <div className="flex h-full flex-col bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-r border-white/30 dark:border-gray-700/30 shadow-glass">
            {/* 헤더 */}
                ...
                return (
                  ...
                  >
                    <Link
                      ...
                      className={`group flex items-center space-x-2 lg:space-x-3 px-3 py-3 rounded-xl lg:rounded-2xl text-sm font-medium transition-all duration-200 hover:scale-105 ${
                        item.current
                          ? "bg-gradient-to-r from-brand-500 to-brand-600 text-white shadow-soft"
                          : "text-gray-700 dark:text-gray-300 hover:bg-white/50 dark:hover:bg-gray-700/50 backdrop-blur-sm"
                      }`}
